...
new eSubprogram('formGenerator', function(onfinish) {
    ...
    self.init = function() {
        ...
        self.view.V.submit.onclick = function() {
            ...
            self.data.custom(self.updateObj, self.view.C.currentUpdate, self.view.C.currentLangUpdate, self);
            
            //-log('!', self.view.C.currentUpdate, self.view.C.currentLangUpdate);
            
            self.onsubmit(self.view.C.currentUpdate, self.view.C.currentLangUpdate, self);
        }
