...
String.prototype.toLen = Number.prototype.toLen;
...
Function.prototype.ENV = f(env) {
    var fn = this;
    env = env || {};
    
    var newFn = f() {
        var args = RNG(arguments);
...
String.prototype.rp = function(from, to) { return this.split(from).join(to); }
...
Array.prototype.contains  = function(val) { return this.indexOf(val) >= 0; }
...
String.prototype.sl = function(query) { return sl(this, query, true); }
Array.prototype.sl  = function(query) { return sl(this, query); }
